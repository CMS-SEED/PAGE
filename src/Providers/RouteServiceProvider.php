...
namespace Cms_Framework_Seed\Page\Providers;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Cms_Framework_Seed\Page\Http\Controllers';
    ...
    public function boot()
    {
        ...
        if (Request::is('*/page/page/*')) {
            Route::bind('page', function ($id) {
                $page = $this->app->make(\Cms_Framework_Seed\Page\Interfaces\PageRepositoryInterface::class);
