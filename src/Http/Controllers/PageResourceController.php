...
namespace Cms_Framework_Seed\Page\Http\Controllers;

use App\Http\Controllers\ResourceController as BaseController;
use Cms_Framework_Seed\Page\Http\Requests\PageRequest;
...
class PageResourceController extends BaseController
{
    ...
    public function __construct(PageRepositoryInterface $page)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Cms_Framework_Seed\Page\Repositories\Criteria\PageResourceCriteria::class);
    }
    ...
    public function index(PageRequest $request)
    {
        if ($this->response->typeIs('json')) {
            ...
            $data      = $this->repository
                ->setPresenter(\Cms_Framework_Seed\Page\Repositories\Presenter\PageListPresenter::class)
