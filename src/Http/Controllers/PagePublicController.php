...
class PagePublicController extends BaseController
{
     ...
     * Constructor.
     *
     * @param type \Cms_Framework_Seed\Page\Interfaces\PageInterface $page
     *
     * @return type
     */
    public function __construct(\Cms_Framework_Seed\Page\Interfaces\PageRepositoryInterface $page)
    {
        parent::__construct();
        $this->model = $page;
    }
