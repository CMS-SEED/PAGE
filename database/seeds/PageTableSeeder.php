...
class PageTableSeeder extends Seeder
{
    public function run()
    {
        DB::table(config('cms_framework_seed.page.page.table'))->insert([
            ...
            [
                ...
                'name'             => 'About Us',
                'slug'             => 'about-us',
                'heading'          => 'Meet Cms_Framework_Seed',
                'title'            => 'About Us',
                ...
                'meta_description' => 'This is a started theme for Cms_Framework_Seed cms, you can customize according to your requirement.',
                'images'           => null,
                'abstract'         => null,
                'order'            => 0,
                'banner'           => null,
